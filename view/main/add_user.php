		...
		<div class="container">
			...
			<form action="" method="POST" role="form" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input name="lavel" type="text" class="form-control" id="" placeholder="Input field">
				</div>
				<button name="action" value="save_user" type="submit" class="btn btn-primary">Add</button>
			</form>
		</div>
