	...
	<body>
		...
		<form action="" method="POST" class="form-inline" role="form">
			...
			<div class="form-group">
				<label>Card ID</label>
				<input name="cardID" type="text" class="form-control " id="" placeholder="Nhập mã tối đa 8 kí tự" maxlength="8" value="<?php echo $cardID; ?>"> <br>
				<label>Book ID</label>
				<input name="bookID" type="text" class="form-control " id="" placeholder="Nhập mã tối đa 6 kí tự" maxlength="6">
			</div>		
